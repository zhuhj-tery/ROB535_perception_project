...
class Plotter:
    ...
    def log_cnn_training(self, epoch):
        ...
        """
        train_acc, train_loss, _,_ = self.stats[-1]
    ...
    def update_cnn_training_plot(self, epoch):
        ...
        self.axes[0].plot(xrange, [s[0] for s in self.stats], linestyle='--', marker='o', color='r')
        self.axes[1].plot(xrange, [s[1] for s in self.stats], linestyle='--', marker='o', color='r')
        self.axes[0].legend(['Train'])
        self.axes[1].legend(['Train'])
        plt.pause(0.00001)
